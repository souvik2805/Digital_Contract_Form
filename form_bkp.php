...
Crisp Digital India Private Limited" data-errormessage-value-missing="Advertiser /company name is required*" data-prompt-position="bottomLeft" >
          ...
          <div class="form-row">
           ...
           <div class="form-row">
               ...
               <div class="form-group col-md-4">
                  <textarea  class="form-control" type="text" name="description_2"></textarea>
               </div>
               <div class="form-group col-md-4">
           ...
           <div class="form-row">
            <div class="form-group col-md-6">
              <h5 class="office-only">FOR OFFICE USE ONLY</h5>
               <table class="table table-bordered" style="background-color: rgba(0,0,0,.03);">
                      <tr>
                        <th>CHEQUE DATES</th>
                        <td> 
                      ...
                      <tr>
                        <th>CHEQUE NO/S</th>
                        <td><textarea  class="form-control validate[required]" type="text" name="c_no" data-errormessage-value-missing="Chaque no is required*" data-prompt-position="bottomLeft"></textarea>
                        </td>
                      </tr>

                       <tr>
                        <th>CHEQUE AMOUNT</th>
                        <td><textarea type="text" class="form-control validate[required]" name="c_amount" data-errormessage-value-missing="Chaque amount is required*" data-prompt-position="bottomLeft"></textarea></td>
                      </tr>

                      <tr>
                        <th>S.E / MANAGER NAME</th>
                        <td><textarea type="text" class="form-control validate[required]" name="c_manager_name" data-errormessage-value-missing="S.E / MANAGER NAME is required*" data-prompt-position="bottomLeft"></textarea></td>
                      </tr>
            ...
            <div class="form-row">
               <div class="form-group col-md-12">
                  ...
                  <div class="col-md-11" style="padding-left: 20px;color: blue;font-size: 18px;;">
                     <input type="checkbox"  class="validate[required]" data-errormessage-value-missing="This is required*" data-prompt-position="bottomLeft">
